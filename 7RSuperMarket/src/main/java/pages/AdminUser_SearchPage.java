...
public class AdminUser_SearchPage {
	...
	WaitUtility utilities = new WaitUtility();
	...
	public boolean isSearchDataIsDisplayed(String input) {
		utilities.waitForThePresenceOfElement(driver,
				By.xpath("//table[@class='table table-bordered table-hover table-sm']/tbody/tr/td"));
