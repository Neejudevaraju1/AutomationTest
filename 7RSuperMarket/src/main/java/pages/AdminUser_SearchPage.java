...
PageUtilities utility=new PageUtilities();
	...
	@FindBy(xpath="//input[@id='un']")WebElement enterName;
	@FindBy(xpath="//select[@id='ut']")WebElement selectUser_Type;
	@FindBy( xpath="//button[@name='Search']")WebElement adminSearchButton;
	@FindBy(xpath="//table[@class='table table-bordered table-hover table-sm']/tbody/tr/td")WebElement tabledata;
	...
	public AdminUser_SearchPage selectUserFromDropDown(String usertype) {
		utility.selectFromDropDown_ByValue(selectUser_Type, usertype);
		return this;
	...
	public boolean isSearchDataIsDisplayed(String input) {
		List<WebElement>data=driver.findElements(By.xpath("//table[@class='table table-bordered table-hover table-sm']/tbody/tr/td"));
