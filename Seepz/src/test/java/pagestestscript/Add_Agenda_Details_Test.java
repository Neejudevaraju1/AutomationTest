...
public class Add_Agenda_Details_Test extends Base {
	...
	@Test
	public void verifyThatTheUserIsAbleToAddAgendaDetails() throws IOException, InterruptedException {
		...
		addDetails.clickEditDetails().addProposalDetails("test").addDetailOnSecondColoumn("add test")
				.addDetailsOnThirdColoumn("test add").addDetailsToFourthColoumn("testing").addDetailsToFifthColumn("test decision");
